module BottomBarSprite (
    ...
    // Image properties for Bottom Bar
    localparam IMG_W  = 587;
    localparam IMG_H  = 43;
    localparam IMG_X0 = 29;
    localparam IMG_Y0 = 434;
    localparam IMG_X1 = IMG_X0 + IMG_W; // exclusive
    localparam IMG_Y1 = IMG_Y0 + IMG_H; // exclusive

    // 587 * 43 = 25,241 pixels
    (*ROM_STYLE="block"*)
    reg [7:0] image_mem [0:25240];
    
    // Convert screen coordinates to image coordinates
    wire [9:0] img_x = pixel_x - IMG_X0; // 0..586
    wire [5:0] img_y = pixel_y - IMG_Y0; // 0..42

    // Address in memory = y * width + x
    wire [15:0] addr = img_y * IMG_W + img_x;
    ...
    initial begin
        $readmemh("bottom_bar.mem", image_mem);
    end
